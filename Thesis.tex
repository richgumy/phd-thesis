...
%%	\addtocounter{page}{1}%
%	\newpage}
%\newcommand\blankpage{\if@openright\cleardoublepage\else\clearpage\fi
%	\thispagestyle{plain}%
...
\def \thesistitle{Integration of pressure mapping and actuation in soft electroactive elastomer composites}
...
%	\textit{``PHD stands for Permanent Head Damage''}
	\textit{``We've made good progress with the brains of robots but their bodies are still primitive''}
	\begin{flushright}
		C. Keplinger, 2019
	\end{flushright}
