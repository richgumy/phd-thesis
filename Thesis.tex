...
\title  {Soft Electroactive Elastomer Bodies that Can Sense and Contract}
...
\begin{itemize}
    ...
    \item Other office - for ping pong madness.
    ...
    \item Technicians - Throughout the mechanical and electrical department.
    ...
    \item German people for giving me a home to type out words.
\end{itemize}
...
\import{Chapters/}{Chapter7.tex} % DEA-EIT wearable hardware?

\lhead{\emph{\chapviiiname}}
\import{Chapters/}{Chapter8.tex} % Conclusions and Future work
