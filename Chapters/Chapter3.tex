...
The charging theory was mitigated by using an alternating polarity measurement technique. The reversible current source helped to mitigate the charging effects seen, but a general downward trend in resistance was still observed as shown in Figure \ref{fig:repeatability_pulse_trains}.  % Where's the before and after comparison??
\begin{figure}[H]
	\centering
...
% give quantitative relaxation results...
...
% Many repeated behaviours.. Mathematical relationships found...
