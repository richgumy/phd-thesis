...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{Figures/xsensor.png} % permission granted by Bruce. Cheers Bruce.
...
Soft resistive pressure mapping has been commonly achieved in the past by using arrays of piezoresistive sensor elements \cite{,,,,}. The resistive elements can be made using several different flexible piezoresistive materials.
\begin{itemize}
	\item Conductive particle polymer composites \cite{Sun2020,Lu2014,Spahr2017}
	\item Intrinsically conductive polymers \cite{Lu2014,Hazelton2023}
	\item Microfluidic metals \cite{Park2010,Jung2015,Kim2019}
	\item Hydrogel structures \cite{Yuk2016,Park2022,Chen2023}
	\item Flexible piezoresistive semiconductors \cite{Xu2023,Sim2019}
\end{itemize}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.6\linewidth]{Figures/HASEL_manuf.jpg}
...
The number topologies possible with HASEL actuators is vast. Some topologies of HASELs include torus, planar linear\citep{Acome2018}, scorpion metasoma\citep{Mitchell2019}.
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.6\linewidth]{Figures/DEA_basic_diagram.png}
...
\subsection{Modelling Conduction mechanism}
The typical fabrication process stated in Section \ref{sec:Fabricating Conductive Particle Elastomer Composites} for CPECs shows that the dispersion of conductive particles will always vary. 
