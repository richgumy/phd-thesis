...
\begin{figure}[H]
	\centering
	\subfloat[Elastomer pre-stretch method]{\includegraphics[width=5cm]{Figures/DEA_fab_mech.jpg}\label{subfig:DEA_prestretch}}
	\hspace{0.5cm}
...
\begin{figure}[H]
	\centering
 val	\subfloat[The reference DEA made with CB powder compliant electrodes]{\includegraphics[width = 5cm]{Figures/CB_DEA_crop.jpg}\label{subfig:ref_DEA}}
	\hspace{1cm}
...
\begin{figure}[H]
	...
	\vspace{0.3cm}
	% made using www.desmos.com/calculator (graphing calculator)
	% To do: re-make these plots with better font size.
...
\begin{figure}[H]
	...
	% \caption{Comparing the measured DEA strain, the theoretical strain given the assumed $K$ and $\epsilon_r$ values, 142 kPa and 4.5 respectively, and the fitted curve using either assumed $K$ or $\epsilon_r$ value and fitting the other. X* denotes the fitted parameter given our assumption of the other parameter is correct.}
...
\begin{figure}[H]
	\centering
	\subfloat[$z_{ce}$ = 0.5 mm]{\includegraphics[width=0.3\linewidth]{Figures/DEA.5_CBSR_8p_1_9push_15strain_120s_1mA_2_frame149.jpg}\label{subfig:DEA.5_strain15_L1}}
%	\hspace{0.05cm}
	\subfloat[$z_{ce}$ = 1 mm]{\includegraphics[width=0.3\linewidth]{Figures/DEA1_CBSR_8p_1_9push_15strain_120s_1mA_2_frame134.jpg}\label{subfig:DEA1_strain15_L1}}
%	\hspace{0.05cm}
	\subfloat[ $z_{ce}$ = 2 mm]{\includegraphics[width=0.3\linewidth]{Figures/DEA2_CBSR_8p_1_9push_15strain_120s_1mA_2_frame162.jpg}\label{subfig:DEA2_strain15_L1}}
%	\hspace{0.05cm}
	\subfloat[Scale]{\includegraphics[width=0.07\linewidth]{Figures/DEAX_CBSR_8p_1_9push_15strain_120s_1mA_2_cb.jpg}\label{subfig:DEAX_strain15_cbar}}
	\vspace{0.1cm}
...
\begin{figure}[H]
	\centering
	\subfloat[$z_{ce}$ = 0.5 mm]{\includegraphics[width=0.35\linewidth]{Figures/polar_ecom_DEA.5_CBSR_8p_1_9push_20strain_120s_1mA_1.png}\label{subfig:e_com_500um_ce}}
	\hspace{1cm}
	\subfloat[$z_{ce}$ = 1 mm]{\includegraphics[width=0.35\linewidth]{Figures/polar_ecom_DEA1_CBSR_8p_1_9push_20strain_120s_1mA_1.png}\label{subfig:e_com_1mm_ce}}
	\hspace{1cm}
	\subfloat[$z_{ce}$ = 2 mm]{\includegraphics[width=0.35\linewidth]{Figures/polar_ecom_DEA2_CBSR_8p_1_9push_20strain_120s_1mA_1.png}\label{subfig:e_com_2mm_ce}}
	\hspace{4cm}
	\subfloat[Load locs]{\includegraphics[width=0.1\linewidth]{Figures/polar_ecom_DEA_EIT_Lx_legend.jpg}\label{subfig:lx_legend_ce}}
	\vspace{0.1cm}
...
\begin{figure}[H]
	\centering
	\subfloat[$z_{ce}$ = 0.5 mm]{\includegraphics[width=0.35\linewidth]{Figures/polar_ecom_DEA.5_EIT_CBSR_8p_1_9push_20strain_120s_1mA_1_simp.jpg}\label{subfig:e_com_500um_dea}}
	\hspace{1cm}
	\subfloat[$z_{ce}$ = 1 mm]{\includegraphics[width=0.35\linewidth]{Figures/polar_ecom_DEA1_EIT_CBSR_8p_1_9push_20strain_120s_1mA_1_simp.jpg}\label{subfig:e_com_1mm_dea}}
	\hspace{1cm}
	\subfloat[$z_{ce}$ = 2 mm]{\includegraphics[width=0.35\linewidth]{Figures/polar_ecom_DEA2_EIT_CBSR_8p_1_9push_20strain_120s_1mA_1_simp.jpg}\label{subfig:e_com_2mm_dea}}
	\hspace{4cm}
	\subfloat[Load locs]{\includegraphics[width=0.1\linewidth]{Figures/polar_ecom_DEA_EIT_Lx_legend.jpg}\label{subfig:lx_legend_dea}}
	\vspace{0.1cm}
...
\begin{table}[H]
	...
	\begin{tabular}{c|c|c}
		...
		\hline
		2 & 4.10 $\pm$ 1.9 & 46.03 $\pm$ 0.51\\ % TODO: redo SF values!
...
\begin{table}[H]
	...
	\begin{tabular}{c|c|c}
		...
		0.5 & 8.83 $\pm$ 1.5 & 81.64 $\pm$ 8.0\\ % done
	\end{tabular}
\end{table}
...
\begin{figure}[H]
	\centering
	\subfloat[$V_{\mathrm{DEA}} = 1 kV$]{\includegraphics[width=0.3\linewidth]{Figures/DEA_EIT_1mm_manual_3load_1kV_1_frame14_crop.png}\label{subfig:DEA-EIT_steady_state_loads_1kV}}
	\hspace{0.1cm}
	\subfloat[$V_{\mathrm{DEA}} = 4 kV$]{\includegraphics[width=0.3\linewidth]{Figures/DEA_EIT_1mm_manual_3load_4kV_1_frame18_crop.png}\label{subfig:DEA-EIT_steady_state_loads_1kV}}
	\hspace{0.1cm}
	\subfloat[$V_{\mathrm{DEA}} = 7 kV$]{\includegraphics[width=0.35\linewidth]{Figures/DEA_EIT_1mm_manual_3load_7kV_1_frame17.png}\label{subfig:DEA-EIT_steady_state_loads_1kV}}
	\hspace{0.1cm}
...
\end{figure}
The next set of experiments observed the transient effects of a high voltage step input the DEA during an EIT cycle. Artefacts such as the ones given in Figure \ref{fig:DEA-EIT_transients} occur due the inrush/outrush currents across the DEA's capacitance. 
\begin{figure}[H]
	\centering
...
A key limitation seen in many soft robotic systems is the connection between the rigid electrodes and connecting electronics and the soft electroactive material. In this work when the copper tape was used with thinner electrodes the robustness of the compliant sensor domain became easy to break with minimal handling force. This could be mitigated in future with a thinner copper taper or more of a gradual change in rigidity between the sensing material (which doubles as the DEA compliant electrodes in this case) and 'rigid' electrodes.
