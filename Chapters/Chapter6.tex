...
\begin{figure}[H]
	...
	\vspace{0.3cm}
	\caption{An unloaded DEA with a captured during various voltage, $V_{DEA}$, step input artefacts.}
...
\begin{figure}[H]
	...
	\caption{Render of a concept DEA daughter board mounted on the portable ERT board.}
