...
\end{figure}
For each stress relaxation Equation \ref{eqn:kelvin_general_n2} was fitted to the data. Analogously the same was done for the resistive relaxation events observed similar to the tensile testing shown in the previous chapter.
\begin{figure}[H]
    \centering
