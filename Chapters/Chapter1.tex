...
\begin{enumerate}
	...
	\item Investigate energy generation potential in the above electrical impedance tomography dielectric elastomer actuator device.
\end{enumerate}
